    ...
    return dbc.Row(
        ...
        children=[
            dbc.Col(
                ...
                children=[
                    get_index_select(
                        graph_id=f"sectors-0-{graph_id}",
                        name="IDX 0",
                        disabled=False,
                        value="Eisen- und Stahlerzeugung",
                        options=sectors_indices[0],
                    )
                ],
            ),
        ],
    ...
    return dbc.Row(
        ...
        children=[
            dbc.Col(
                ...
                children=[
                    get_index_select(
                        graph_id=f"sector-energy-0-{graph_id}",
                        name="IDX 0",
                        disabled=False,
                        value="Gewinnung von Erdöl und Erdgas",
                        options=sector_energy_indices[0],
                    )
                ],
            ),
        ],
    ...
    return dbc.Row(
        ...
        children=[
            dbc.Col(
                ...
                children=[
                    get_index_select(
                        graph_id=f"res-0-{graph_id}",
                        name="IDX 0",
                        options=renewables_indices[0],
                        value="Anrechenbarer Erneuerbare (TJ)",
                        disabled=False,
                    )
                ],
            ),
            dbc.Col(
                ...
                children=[
                    get_index_select(
                        graph_id=f"res-1-{graph_id}",
                        name="IDX 1",
                        options=renewables_indices[1],
                        value="Gesamt",
                    )
                ],
            ),
            dbc.Col(
                ...
                children=[
                    get_index_select(
                        graph_id=f"res-2-{graph_id}",
                        name="IDX 2",
                        options=renewables_indices[2],
                        value="Gesamt",
                    )
                ],
            ),
    ...
    return dbc.Row(
        ...
        children=[
            dbc.Col(
                ...
                children=[
                    get_index_select(
                        graph_id=f"eev-0-{graph_id}",
                        name="IDX 0",
                        options=eev_indices[0],
                        value="Bruttoinlandsverbrauch",
                        disabled=False,
                    )
                ],
            ),
            dbc.Col(
                ...
                children=[
                    get_index_select(
                        graph_id=f"eev-1-{graph_id}",
                        name="IDX 1",
                        options=eev_indices[1],
                        value="Gesamt",
                    )
                ],
            ),
            dbc.Col(
                ...
                children=[
                    get_index_select(
                        graph_id=f"eev-2-{graph_id}",
                        name="IDX 2",
                        options=eev_indices[2],
                        value="Gesamt",
                    )
                ],
            ),
            dbc.Col(
                ...
                children=[
                    get_index_select(
                        graph_id=f"eev-3-{graph_id}",
                        name="IDX 3",
                        options=eev_indices[3],
                        value="Gesamt",
                    )
                ],
            ),
            dbc.Col(
                ...
                children=[
                    get_index_select(
                        graph_id=f"eev-4-{graph_id}",
                        name="IDX 4",
                        options=eev_indices[4],
                        value="Gesamt",
                    )
                ],
            ),
    ...
    return dbc.Row(
        ...
        children=[
            dbc.Col(
                width=12,
                children=[
                    dbc.Label("Chart type", style=label_style),
