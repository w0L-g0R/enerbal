                            ...
                            dbc.Col(
                                ...
                                children=[
                                    dbc.Tabs(
                                        [
                                            dbc.Tab(
                                                label="EEV", tab_id=f"tab-1-{graph_id}",
                                            ),
                                            dbc.Tab(
                                                label="NEA", tab_id=f"tab-2-{graph_id}",
                                            ),
                                            dbc.Tab(
                                                label="THG", tab_id=f"tab-3-{graph_id}",
                                            ),
                                            dbc.Tab(
                                                label="STATS",
                                                tab_id=f"tab-4-{graph_id}",
                                            ),
                                        ],
                                        id=f"tabs-{graph_id}",
                                        card=True,
                                        active_tab=f"tab-1-{graph_id}",
                                    ),
                                ],
                            ),
                        ],
