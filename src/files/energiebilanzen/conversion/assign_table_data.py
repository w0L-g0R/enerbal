...
from files.energiebilanzen.convert.preprocess_renewables import (
...
def assign_sector_energy_consumption_table(
    ...
    if start_index == [-1]:
        ...
        sector_energy_df.loc[:, IDX[province, energy_source, :]] = float(
            "NaN"
        )
