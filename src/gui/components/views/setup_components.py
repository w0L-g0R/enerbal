            ...
            children=[
                dbc.Col(
                    ...
                    children=[get_index_select(
                        graph_id=f"sectors-0-{graph_id}", name="IDX 0", value="Eisen- und Stahlerzeugung", options=sectors_indices[0])],
                ),
            ],
        ),
    )
        ...
        dbc.Row(
            ...
            children=[
                dbc.Col(
                    width=12,
                    children=[get_index_select(
                        graph_id=f"sector-energy-0-{graph_id}", name="IDX 0", value="Gewinnung von Erdöl und Erdgas", options=sectors_energy_indices[0])],
                ),
            ],
        ),
    )
