...
def test_per_energy_source_and_balance_aggregate_stacked_usage_categories(
    test_dataset,
    test_nea_workbook,
    test_provinces,
    ...
    test_write_to_xlsx(
        ...
        sheet_name="ES_BAGGS_STACKED_UC",
    )


@pytest.mark.dependency(
    depends=["test_per_energy_source_and_balance_aggregate_stacked_usage_categories"]
)
